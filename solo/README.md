# TechDesk Solo — version history

Installer files themselves live under this repo's **Releases**, not in this
folder (see the root [README](../README.md) for why, and for the steps to
